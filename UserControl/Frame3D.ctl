  ...
  Dim intDrawWidth  As Integer
   ...
   With UserControl
      ...
      Case 2 '// Raised
         ...
         '// Top
         UserControl.Line (sngBevelWidth + lngCorner, sngBevelWidth)-(.ScaleWidth - lngCorner - 1 - sngBevelWidth, _
            sngBevelWidth), mlng3DHighlight
         '// Left
         UserControl.Line (sngBevelWidth, lngCorner + sngBevelWidth)-(sngBevelWidth, .ScaleHeight - sngBevelWidth - _
            lngCorner - 1), mlng3DHighlight
         '// Right
         UserControl.Line (.ScaleWidth - sngBevelWidth - 1, lngCorner + sngBevelWidth)-(.ScaleWidth - sngBevelWidth - 1, _
            .ScaleHeight - lngCorner - sngBevelWidth - 1), mlng3DShadow
         '// Bottom
         UserControl.Line (lngCorner + sngBevelWidth, .ScaleHeight - sngBevelWidth - 1)-(.ScaleWidth - sngBevelWidth - _
            lngCorner - 1, .ScaleHeight - sngBevelWidth - 1), mlng3DShadow

         If lngCorner Then
            '// Top Left
            UserControl.Circle (lngCorner + sngBevelWidth, lngCorner + sngBevelWidth), lngCorner, mlng3DHighlight, 1.57, _
               3.14
            '// Bottom Left
            UserControl.Circle (lngCorner + sngBevelWidth, .ScaleHeight - sngBevelWidth - lngCorner - 1), lngCorner, _
               mlng3DHighlight, 3.14, 4.71
            '// Top Right
            UserControl.Circle (.ScaleWidth - lngCorner - sngBevelWidth - 1, sngBevelWidth + lngCorner), lngCorner, _
               mlng3DShadow, 6.28, 1.57
            '// Bottom Right
            UserControl.Circle (.ScaleWidth - lngCorner - sngBevelWidth - 1, .ScaleHeight - sngBevelWidth - lngCorner - _
               1), lngCorner, mlng3DShadow, 4.71
         End If
      ...
      Case 1 '// Inserted
         ...
         '// Top
         UserControl.Line (sngBevelWidth + lngCorner, sngBevelWidth)-(.ScaleWidth - lngCorner - 1 - sngBevelWidth, _
            sngBevelWidth), mlng3DShadow
         '// Left
         UserControl.Line (sngBevelWidth, lngCorner + sngBevelWidth)-(sngBevelWidth, .ScaleHeight - sngBevelWidth - _
            lngCorner - 1), mlng3DShadow
         '// Right
         UserControl.Line (.ScaleWidth - sngBevelWidth - 1, lngCorner + sngBevelWidth)-(.ScaleWidth - sngBevelWidth - 1, _
            .ScaleHeight - lngCorner - sngBevelWidth - 1), mlng3DHighlight
         '// Bottom
         UserControl.Line (lngCorner + sngBevelWidth, .ScaleHeight - sngBevelWidth - 1)-(.ScaleWidth - sngBevelWidth - _
            lngCorner - 1, .ScaleHeight - sngBevelWidth - 1), mlng3DHighlight

         If lngCorner Then
            '// Top Left
            UserControl.Circle (lngCorner + sngBevelWidth, lngCorner + sngBevelWidth), lngCorner, mlng3DShadow, 1.57, _
               3.14
            '// Bottom Left
            UserControl.Circle (lngCorner + sngBevelWidth, .ScaleHeight - sngBevelWidth - lngCorner - 1), lngCorner, _
            ...
            '// Bottom Right
            UserControl.Circle (.ScaleWidth - lngCorner - sngBevelWidth - 1, .ScaleHeight - sngBevelWidth - lngCorner - _
               1), lngCorner, mlng3DHighlight, 4.71
         End If
      ...
      Case 3 '// Flat Shadow
         ...
         With UserControl
            ...
            Call RoundRect(.hdc, sngBevelWidth, sngBevelWidth, .ScaleWidth - sngBevelWidth, .ScaleHeight - _
               sngBevelWidth, lngCorner, lngCorner)
         End With
  ...
  Dim mlngCornerDia As Long
   ...
   With UserControl
      ...
      Case 11 '// [rPanel Raised]
         ...
         '// Right
         UserControl.Line (.ScaleWidth - 1, mlngCornerRadius)-(.ScaleWidth - 1, .ScaleHeight - mlngCornerRadius - 1), _
            mlng3DShadow
         '// Bottom
         UserControl.Line (mlngCornerRadius, .ScaleHeight - 1)-(.ScaleWidth - mlngCornerRadius - 1, .ScaleHeight - 1), _
            mlng3DShadow
         '// Top Left
         UserControl.Circle (mlngCornerRadius, mlngCornerRadius), mlngCornerRadius, mlng3DHighlight, 1.57, 3.14
         '// Bottom Left
         UserControl.Circle (mlngCornerRadius, .ScaleHeight - mlngCornerRadius - 1), mlngCornerRadius, mlng3DHighlight, _
            3.14, 4.71
         '// Top Right
         UserControl.Circle (.ScaleWidth - mlngCornerRadius - 1, mlngCornerRadius), mlngCornerRadius, mlng3DShadow, _
            6.28, 1.57
         '// Bottom Right
         UserControl.Circle (.ScaleWidth - mlngCornerRadius - 1, .ScaleHeight - mlngCornerRadius - 1), mlngCornerRadius, _
            mlng3DShadow, 4.71
         Call SetWindowRgn(.hWnd, CreateRoundRectRgn(0&, 0&, .ScaleWidth + 1, .ScaleHeight + 1, mlngCornerDia, _
            mlngCornerDia), True)
      ...
      Case 12 '// [Inserted Panel Round Corners]
         ...
         '// Bottom Left
         UserControl.Circle (mlngCornerRadius, .ScaleHeight - mlngCornerRadius - 1), mlngCornerRadius, mlng3DShadow, _
            3.14, 4.71
         '// Top Right
         UserControl.Circle (.ScaleWidth - mlngCornerRadius - 1, mlngCornerRadius), mlngCornerRadius, mlng3DHighlight, _
            6.28, 1.57
         '// Bottom Right
         UserControl.Circle (.ScaleWidth - mlngCornerRadius - 1, .ScaleHeight - mlngCornerRadius - 1), mlngCornerRadius, _
            mlng3DHighlight, 4.71
         Call SetWindowRgn(.hWnd, CreateRoundRectRgn(0&, 0&, .ScaleWidth + 1, .ScaleHeight + 1, mlngCornerRadius, _
            mlngCornerRadius), True)

      Case Else '// [None rBorder]
         '// Trick to allow FillStyle to work
         .ForeColor = .BackColor
         Call RoundRect(.hdc, 0&, 0&, .ScaleWidth, .ScaleHeight, 0&, 0&)
         Call SetWindowRgn(.hWnd, CreateRoundRectRgn(1&, 1&, .ScaleWidth, .ScaleHeight, mlngCornerDia, mlngCornerDia), _
            True)
      End Select
  ...
  Dim sngNewValue   As Single
   ...
   If mlngFloodValue Then
      ...
      If mudtFloodType Then  '// [Bottom To Top]
         ...
         UserControl.Line (sngBevelWidth, UserControl.ScaleHeight - sngBevelWidth - 1)-(UserControl.ScaleWidth - _
            sngBevelWidth - 1, sngNewValue + sngBevelWidth), mlngFloodColor, BF

      Else '/[Left To Right]

         sngNewValue = (UserControl.ScaleWidth - sngBevelWidth - sngBevelWidth) * mlngFloodValue / 100

         UserControl.Line (sngBevelWidth, sngBevelWidth)-(sngNewValue + sngBevelWidth - 1, UserControl.ScaleHeight - _
            sngBevelWidth - 1), mlngFloodColor, BF
      End If
...
Private Sub ErrHandler(Optional ByVal vblnDisplayError As Boolean = True, _
  ...
  Dim lngFN       As Long
   ...
   Write #lngFN, Now, vstrErrNumber, vstrErrDescription, vstrModuleName, vstrProcName, App.Title & " v" & App.Major & _
      "." & App.Minor & "." & App.Revision, Environ("username"), Environ("computername")
   Close #lngFN
